...
namespace WebNotas_ASP.NETv01.Controllers
{
    public class AsignaturasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AsignaturaID,Codigo,Nombre,Creditos")] Asignatura asignatura)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AsignaturaID,Codigo,Nombre,Creditos")] Asignatura asignatura)
        {
            if (ModelState.IsValid)
            {
